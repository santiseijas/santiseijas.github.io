...
function Experience() {
  return (
    <section>
      <h2>Experiencia</h2>
      <div>
        <h3>React Native Developer, Vass</h3>
        <p>Mar 2024</p>
        <ul>
      ...
      <div>
        <h3>React Native Developer, eccocar</h3>
        <p>Sep 2020 — Mar 2024</p>
        <ul>
      ...
      <div>
        <h3>Prácticas Java Developer, Indra</h3>
        <p>Mar 2019 — Ago 2020</p>
      </div>
      <div>
        <h3>Gestor Comercial, Abanca</h3>
        <p>Jun 2016 — Feb 2018</p>
      </div>
      <div>
        <h3>Camarero, Pizzerias Cambalache</h3>
        <p>Ago 2014 — Jun 2020</p>
      </div>
    </section>
  );
}
